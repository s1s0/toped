...
//                    T      OOO    P       EEEEE   DDDD                    =
// ------------------------------------------------------------------------ =
//           $URL: http://perun/tpd_svn/trunk/toped_wx/tpd_DB/logicop.cpp $
...
//---------------------------------------------------------------------------                
//      $Revision: 170 $
//          $Date: 2005-06-24 00:09:12 +0100 (Fri, 24 Jun 2005) $
//        $Author: skr $
//===========================================================================
...
At this time this object can not be linked properly in a #VPoint list at least
...
//   if (pe1->eventType() != pe2->eventType())
//      return (pe1->eventType() > pe2->eventType()) ? -1 : 1;
   return 0;
 }
