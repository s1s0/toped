...
Section "toped" toped
  ...
  File "winpack64\glu32.dll"
  File "winpack64\toped_example.bat"
  File "winpack64\authors.txt"
  File "winpack64\news.txt"
  File "winpack64\readme.txt"
  File "winpack64\glew32.dll"
  File "winpack64\zlib1.dll"
  File "winpack64\virtuoso2tll.exe"

  ;all for PLT scheme
  SetOutPath $INSTDIR\lib
  File "winpack64\lib\iconv.dll"
  File "winpack64\lib\libracket3m_8aa62o.dll"
