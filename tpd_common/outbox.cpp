...
BEGIN_DECLARE_EVENT_TYPES()
    ...
    DECLARE_EVENT_TYPE(wxEVT_AUI_RESTORE        , 10017)
    DECLARE_EVENT_TYPE(wxEVT_EDITLAYER          , 10018)
    DECLARE_EVENT_TYPE(wxEVT_EXITAPP            , 10019)
    DECLARE_EVENT_TYPE(wxEVT_EXECEXT            , 10020)
    DECLARE_EVENT_TYPE(wxEVT_EXECEXTPIPE        , 10021)
    DECLARE_EVENT_TYPE(wxEVT_EXECEXTDONE        , 10022)
    DECLARE_EVENT_TYPE(wxEVT_RELOADTELLFUNCS    , 10023)
    DECLARE_EVENT_TYPE(wxEVT_TECHEDITUPDATE     , 10024)
