...
tui::style_sample::style_sample(wxWindow *parent, wxWindowID id , std::string init, const layprop::DrawProperties* drawProp) :
   wxControl(parent, id),
...

{
   ...
   _stylesample = DEBUG_NEW style_sample( this, wxID_ANY, init_style, drawProp);
