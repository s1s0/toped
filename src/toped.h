...
//      wxWindow*     mS_log;
      ...
      void    OnFlipVert(wxCommandEvent& WXUNUSED(event)) {_cmdline->parseCommand(wxT("flip_vert();"));}
      void     OnFlipHor(wxCommandEvent& WXUNUSED(event)) {_cmdline->parseCommand(wxT("flip_hor();"));}
