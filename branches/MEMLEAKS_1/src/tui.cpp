...
tui::sgSpinButton::sgSpinButton(wxWindow *parent, wxTextCtrl* textW, const float step, 
  ...
  : wxSpinButton(parent, -1, wxDefaultPosition, wxDefaultSize), _wxText(textW), 
   ...
   wxString ws;
   ws.sprintf("%.*f", _prec, init);
   _wxText->SetValue(ws);
}

void  tui::sgSpinButton::OnSpin(wxSpinEvent&) {
   wxString ws;
   ws.sprintf("%.*f", _prec, GetValue() * _step);
   _wxText->SetValue(ws);
}
...
/*   int4b Istep = View.getstep();
   ...
   _wxText = new wxTextCtrl( this, -1, "", wxDefaultPosition, wxDefaultSize);
...
tui::getGrid::getGrid(wxFrame *parent, wxWindowID id, const wxString &title, wxPoint pos, 
   ...
   g0sizer->Add( new wxStaticText(this, -1, "Grid 0:", 
   ...
   g1sizer->Add( new wxStaticText(this, -1, "Grid 1:", 
                              wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT),
                                                0, wxALL, 5);
   ...
   g2sizer->Add( new wxStaticText(this, -1, "Grid 2:",
                              wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT),
                                                0, wxALL, 5);
...
tui::getCellRef::getCellRef(wxFrame *parent, wxWindowID id, const wxString &title, wxPoint pos, 
      wxString init) : wxDialog(parent, id, title, pos, wxDefaultSize,
                                                   wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)  {
   _rotation = new wxTextCtrl( this, -1, "", wxDefaultPosition, wxDefaultSize);
   _flip = new wxCheckBox(this, -1, "Flip X");
   _nameList = new wxListBox(this, -1, wxDefaultPosition, wxSize(-1,300));
   ...
   // First line up the important things
   wxBoxSizer *spin_sizer = new wxBoxSizer( wxHORIZONTAL );
   spin_sizer->Add( new wxStaticText(this, -1, "Rotation:", 
                              wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT),
...
tui::getCellARef::getCellARef(wxFrame *parent, wxWindowID id, const wxString &title, wxPoint pos, 
   ...
   _numX = new wxTextCtrl( this, -1, "", wxDefaultPosition, wxDefaultSize);
   _numY = new wxTextCtrl( this, -1, "", wxDefaultPosition, wxDefaultSize);
   wxBoxSizer* num_sizer =  new wxBoxSizer( wxHORIZONTAL );
   num_sizer->Add( new wxStaticText(this, -1, "Rows:", 
                              wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT),
                                                0, wxALL | wxALIGN_CENTER, 10);
   ...
   num_sizer->Add(new sgSpinButton(this, _numX, 1, 2, 200, 2, 0),
                                                  0, wxALL | wxALIGN_CENTER, 0);
   num_sizer->Add(0,0,1); // 
   num_sizer->Add( new wxStaticText(this, -1, "Columns:", 
                              wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT),
                                                0, wxALL | wxALIGN_CENTER, 10);
   ...
   num_sizer->Add(0,0,1); // 
   //
   _stepX = new wxTextCtrl( this, -1, "", wxDefaultPosition, wxDefaultSize);
   _stepY = new wxTextCtrl( this, -1, "", wxDefaultPosition, wxDefaultSize);
   wxBoxSizer* step_sizer =  new wxBoxSizer( wxHORIZONTAL );
   step_sizer->Add( new wxStaticText(this, -1, "step X:", 
                              wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT),
                                                0, wxALL | wxALIGN_CENTER, 10);
   ...
   step_sizer->Add( new wxStaticText(this, -1, "step Y:", 
                              wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT),
                                                0, wxALL | wxALIGN_CENTER, 10);
...
tui::getTextdlg::getTextdlg(wxFrame *parent, wxWindowID id, const wxString &title, wxPoint pos) 
   ...
   _size     = new wxTextCtrl( this, -1, "", wxDefaultPosition, wxDefaultSize);
   _rotation = new wxTextCtrl( this, -1, "", wxDefaultPosition, wxDefaultSize);
   _flip = new wxCheckBox(this, -1, "Flip X");
   _text = new wxTextCtrl(this, -1, "", wxDefaultPosition, wxDefaultSize);
   // The window layout
   wxBoxSizer *topsizer = new wxBoxSizer( wxVERTICAL );
   // First line up the important things
   wxBoxSizer *spin_sizer = new wxBoxSizer( wxHORIZONTAL );
   
   spin_sizer->Add( new wxStaticText(this, -1, "Size:", 
                              wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT),
                                                0, wxALL | wxALIGN_CENTER, 10);
