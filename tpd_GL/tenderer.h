...
namespace trend {
   ...
   class TenderLay : public TrendLay {
      ...
      protected:
         ...
         GLsizei*          _sizslix[SLCT_TYPES]; //! arrays of sizes for indexes sets of selected objects
         GLuint*           _fstslix[SLCT_TYPES]; //! arrays of first indexes for selected objects
         // offsets in the VBO
