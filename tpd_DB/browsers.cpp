   ...
   _thesizer(NULL)
{
   ...
   _layerPanel = DEBUG_NEW wxScrolledWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxVSCROLL);
      ...
      case     BT_LAYER_ADD:
         {
            ...
            if (it!= _buttonMap.end())
            {
               ...
               ID = tempButton->GetId();
               layerButton = DEBUG_NEW LayerButton(_layerPanel, ID, wxPoint (x, y), wxSize(szx, szy),
