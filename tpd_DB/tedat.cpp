...
void laydata::TdtBox::drawRequest(trend::Collect& rend) const
{
   rend.box(&_pdata[0]);
}

void laydata::TdtBox::drawSRequest(trend::Collect& rend, const SGBitSet* pslist) const
{
...
void laydata::TdtPoly::drawRequest(trend::Collect& rend) const
{
   rend.poly(_pdata, _psize, &_teseldata);
}

void laydata::TdtPoly::drawSRequest(trend::Collect& rend, const SGBitSet* pslist) const
{
...
void laydata::TdtWire::drawRequest(trend::Collect& rend) const
{
   rend.wire(_pdata, _psize, _width);
}

void laydata::TdtWire::drawSRequest(trend::Collect& rend, const SGBitSet* pslist) const
{
...
void laydata::TdtCellRef::drawRequest(trend::Collect& rend) const
{
   // get overlapping box of the structure ...
...
void laydata::TdtCellRef::drawSRequest(trend::Collect& rend, const SGBitSet*) const
{
   // get overlapping box of the structure ...
   DBbox obox(structure()->cellOverlap());
   // ... translate it to the current coordinates ...
...
void laydata::TdtCellAref::drawRequest(trend::Collect& rend) const
{
...
void laydata::TdtCellAref::drawSRequest(trend::Collect& rend, const SGBitSet*) const
{
...
void laydata::TdtText::drawRequest(trend::Collect& rend) const
{
   // font translation matrix
...
void laydata::TdtText::drawSRequest(trend::Collect& rend, const SGBitSet*) const
{
   // font translation matrix
   CTM ftmtrx =  _translation * rend.topCTM();
   DBbox wsquare(TP(0,0), TP(OPENGL_FONT_UNIT, OPENGL_FONT_UNIT));
...
void  laydata::TdtAuxRef::drawRequest(trend::Collect& rend) const
{
   // get overlapping box of the structure ...
...
void  laydata::TdtAuxRef::drawSRequest(trend::Collect& rend, const SGBitSet*) const
{
